    ...
    <div>
      <div className="border rounded-md w-full">
        <div className="flex justify-between items-center w-full py-4 px-5">
          <div className="flex items-center ">
            <img
              ...
              src="https://cdn.pixabay.com/photo/2023/10/24/03/38/animals-8337310_1280.jpg"
              alt=""
            />
            <div className="pl-2">
        ...
        <div className="w-full">
          <img
            className="w-full"
            src="https://cdn.pixabay.com/photo/2024/01/19/18/00/hydrangeas-8519528_1280.jpg"
            alt=""
          />
        </div>
        ...
        <div className="flex justify-between items-center w-full px-5 py-4">
          <div className="flex items-center space-x-2">
            {isPostLiked ? (
              ...
              <AiOutlineHeart className="w-6 h-6" onClick={handlePostLike} />
            )}
            <FaRegComment
